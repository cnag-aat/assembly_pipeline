...
glen_out = subprocess.check_output("/scratch/project/devel/aateam/src/Assembly_pipeline/v1.0/assembly_pipeline/scripts/fastalength " + fasta + "|awk \'{len += $1} END{print len}\'", shell=True)
